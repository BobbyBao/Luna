...
namespace SharpLuna
{
    ...
    public struct LuaRegister
    {
        ...
        public LuaRegister(string name, LuaNativeFunction func)
        {
            this.name = name;
            this.func = func;
        }
    ...
    public struct Bool : IEquatable<Bool>
    {
        ...
        public static implicit operator bool(Bool value) => value._value == 1;

        public static implicit operator Bool(int value) => new Bool(value != 0);

        public static implicit operator int(Bool value) => value._value;
    }
}
